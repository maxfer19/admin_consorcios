...
import { Wrench, FileText, DollarSign, Building2 } from 'lucide-react';
...
export default function ProviderDashboard() {
  ...
  const stats = [
    { name: 'Órdenes Activas', value: '0', icon: Wrench, color: 'bg-blue-500' },
    { name: 'Presupuestos', value: '0', icon: FileText, color: 'bg-green-500' },
    { name: 'Facturación', value: '$0', icon: DollarSign, color: 'bg-yellow-500' },
    { name: 'Consorcios', value: '0', icon: Building2, color: 'bg-purple-500' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Portal de Proveedores</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <p className="text-neutral-600">Gestiona tus órdenes de trabajo y presupuestos.</p>
        </div>
