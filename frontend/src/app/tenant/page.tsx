...
import { Home, DollarSign, MessageSquare, Calendar } from 'lucide-react';
...
export default function TenantDashboard() {
  ...
  const stats = [
    { name: 'Mi Unidad', value: '-', icon: Home, color: 'bg-blue-500' },
    ...
    { name: 'Reservas', value: '0', icon: Calendar, color: 'bg-orange-500' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Portal del Inquilino</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <p className="text-neutral-600">Accede a la información de tu unidad y el consorcio.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <ul className="space-y-2 text-neutral-600">
            ...
            <li>⏳ Consultar expensas</li>
            <li>⏳ Ver comunicados</li>
            <li>⏳ Reservar amenities</li>
            <li>⏳ Enviar reclamos</li>
          </ul>
        </div>
      </main>
    </div>
